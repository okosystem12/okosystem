...
export const accordionPanel = (title = '', content = '', parentId = nanoid(), id = nanoid(), panelId = nanoid()) => `
<div class="panel panel-default">
    <div class="panel-heading" role="tab" id="${id}">
        <h4 class="panel-title">
            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#${parentId}" href="#${panelId}" aria-expanded="false">${title}</a>
        </h4>
    </div>
